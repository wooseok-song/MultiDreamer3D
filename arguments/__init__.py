...
class GuidanceParams(ParamGroup):
    def __init__(self, parser, opts=None):
        ...
        self.perpneg = True
        self.negative_w = -2.0
        self.front_decay_factor = 2.0
        self.side_decay_factor = 10.0
...
class ConceptParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.step1_layout = False
        self.step1_3d_layout_generator = False
        self.step1_point_cloud_selection = False
        self.step2_auto_concept_parsing = False

        self.concept_num = 5
        self.step1_base_prompt = ""
        self.step1_concept0_prompt = ""
        self.step1_concept1_prompt = ""
        self.step1_concept2_prompt = ""
        self.step1_concept3_prompt = ""
        self.step1_concept4_prompt = ""

        self.step1_load_from_pcd_path = False
        self.step1_concept0_pcd_path = ""
        self.step1_concept1_pcd_path = ""
        self.step1_concept2_pcd_path = ""
        self.step1_concept3_pcd_path = ""
        self.step1_concept4_pcd_path = ""

        self.step1_concept0_transform = [1, 0, 0, 0, 0]
        self.step1_concept1_transform = [1, 0, 0, 0, 0]
        self.step1_concept2_transform = [1, 0, 0, 0, 0]
        self.step1_concept3_transform = [1, 0, 0, 0, 0]
        self.step1_concept4_transform = [1, 0, 0, 0, 0]

        self.step1_concept0_bbox = [0, 0, 0, 0, 0, 0]
        self.step1_concept1_bbox = [0, 0, 0, 0, 0, 0]
        self.step1_concept2_bbox = [0, 0, 0, 0, 0, 0]
        self.step1_concept3_bbox = [0, 0, 0, 0, 0, 0]
        self.step1_concept4_bbox = [0, 0, 0, 0, 0, 0]

        self.step2_LoRA_concept0_path = ""
        self.step2_LoRA_concept1_path = ""
        self.step2_LoRA_concept2_path = ""
        self.step2_LoRA_concept3_path = ""
        self.step2_LoRA_concept4_path = ""

        self.step2_base_prompt = ""
        self.step2_bg_prompt = ""
        self.step2_concept0_prompt = ""
        self.step2_concept1_prompt = ""
        self.step2_concept2_prompt = ""
        self.step2_concept3_prompt = ""
        self.step2_concept4_prompt = ""

        self.step2_lora_scale = 1.0

        self.concept_eval_azimuth_degree = 45
        self.real_data_concept0_path = ""
        self.real_data_concept1_path = ""
        self.real_data_concept2_path = ""
        self.real_data_concept3_path = ""
        self.real_data_concept4_path = ""
